...
=======
 ...
 539:	ff 24 85 70 08 00 00 	jmp    *0x870(,%eax,4)
>>>>>>> 0c92ca4dcf5535cd18046519fa90238b0fce8398
        putc(fd, c);
      }
      state = 0;
...
=======
 ...
 647:	90                   	nop
          s = "(null)";
 648:	ba 66 08 00 00       	mov    $0x866,%edx
        while(*s != 0){
...
=======
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
    p->s.size += bp->s.size;
...
=======
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
...
=======
 741:	8b 3d 7c 0b 00 00    	mov    0xb7c,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 7c 0b 00 00    	mov    0xb7c,%edx
      if((p = morecore(nunits)) == 0)
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 7c 0b 00 00    	mov    %edx,0xb7c
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 7c 0b 00 00 80 	movl   $0xb80,0xb7c
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 80 0b 00 00       	mov    $0xb80,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 80 0b 00 00 80 	movl   $0xb80,0xb80
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 84 0b 00 00 00 	movl   $0x0,0xb84
 7d2:	00 00 00 
    if(p->s.size >= nunits){
