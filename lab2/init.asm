 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 b8 08 00 00 	movzbl 0x8b8(%edx),%edx
 ...
 4b9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 529:	ff 24 85 60 08 00 00 	jmp    *0x860(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 637:	90                   	nop
          s = "(null)";
 638:	ba 56 08 00 00       	mov    $0x856,%edx
        while(*s != 0){
 ...
 651:	a1 6c 0b 00 00       	mov    0xb6c,%eax
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
}
 698:	5e                   	pop    %esi
 699:	5f                   	pop    %edi
 69a:	5d                   	pop    %ebp
 ...
 6c9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6cc:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 3d 6c 0b 00 00    	mov    0xb6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 4f                	jae    780 <malloc+0xa0>
    ...
    if(p == freep)
 731:	8b 3d 6c 0b 00 00    	mov    0xb6c,%edi
 ...
 75a:	e8 f1 fe ff ff       	call   650 <free>
  return freep;
 75f:	8b 15 6c 0b 00 00    	mov    0xb6c,%edx
 ...
 78c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 78f:	89 15 6c 0b 00 00    	mov    %edx,0xb6c
}
 ...
 79f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 6c 0b 00 00 70 	movl   $0xb70,0xb6c
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 70 0b 00 00       	mov    $0xb70,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 70 0b 00 00 70 	movl   $0xb70,0xb70
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7bb:	c7 05 74 0b 00 00 00 	movl   $0x0,0xb74
 7c2:	00 00 00 
    if(p->s.size >= nunits){
