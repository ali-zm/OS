...
int main(void) {
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    ...
    int pid = getpid();
  11:	e8 fd 02 00 00       	call   313 <getpid>
    if (fork() == 0) 
  16:	e8 70 02 00 00       	call   28b <fork>
  1b:	85 c0                	test   %eax,%eax
  1d:	75 05                	jne    24 <main+0x24>
    {
  ...
  1f:	e8 6f 02 00 00       	call   293 <exit>
        ...
        wait();
  24:	e8 72 02 00 00       	call   29b <wait>
    sleep(10);
  29:	83 ec 0c             	sub    $0xc,%esp
  2c:	6a 0a                	push   $0xa
  2e:	e8 f0 02 00 00       	call   323 <sleep>

    list_active_processes();
  33:	e8 0b 03 00 00       	call   343 <list_active_processes>
