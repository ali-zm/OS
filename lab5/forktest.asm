...
0000041b <get_most_syscalls>:
SYSCALL(get_most_syscalls)
 41b:	b8 19 00 00 00       	mov    $0x19,%eax
 420:	cd 40                	int    $0x40
 422:	c3                   	ret    

00000423 <list_active_processes>:
