...
_test_reentrantlock:     file format elf32-i386
...
int main()
{
  ...
  13:	51                   	push   %ecx
    ...
    {
        int pid = fork();
  14:	e8 b2 02 00 00       	call   2cb <fork>
        if(!pid)
  19:	85 c0                	test   %eax,%eax
  1b:	74 4c                	je     69 <main+0x69>
        {
  ...
  33:	75 df                	jne    14 <main+0x14>
    } 
    for(int i = 0; i < 5; i ++)
        wait();
  35:	e8 a1 02 00 00       	call   2db <wait>
  3a:	e8 9c 02 00 00       	call   2db <wait>
  3f:	e8 97 02 00 00       	call   2db <wait>
  44:	e8 92 02 00 00       	call   2db <wait>
  49:	e8 8d 02 00 00       	call   2db <wait>
    printf(1, "DONE\n");
  4e:	83 ec 08             	sub    $0x8,%esp
  51:	68 c0 07 00 00       	push   $0x7c0
  56:	6a 01                	push   $0x1
  ...
  6c:	6a 05                	push   $0x5
  6e:	e8 50 03 00 00       	call   3c3 <test_reentrantlock>
            exit();
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba c6 07 00 00       	mov    $0x7c6,%edx
        while(*s != 0){
