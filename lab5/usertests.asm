...
0000398b <move_file>:
SYSCALL(move_file)
    398b:	b8 17 00 00 00       	mov    $0x17,%eax
    3990:	cd 40                	int    $0x40
    3992:	c3                   	ret    

00003993 <create_palindrome>:
