...
int main(void) {
  ...
  18:	e8 53 04 00 00       	call   470 <printf>
    ...
    int pid = getpid();
  1d:	e8 11 03 00 00       	call   333 <getpid>
    if (fork() == 0) 
  22:	e8 84 02 00 00       	call   2ab <fork>
  ...
  3c:	e8 72 02 00 00       	call   2b3 <exit>
        ...
        wait();
  41:	e8 75 02 00 00       	call   2bb <wait>
    sleep(10);
  46:	83 ec 0c             	sub    $0xc,%esp
  49:	6a 0a                	push   $0xa
  4b:	e8 f3 02 00 00       	call   343 <sleep>

    list_active_processes();
  50:	e8 0e 03 00 00       	call   363 <list_active_processes>
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba c3 07 00 00       	mov    $0x7c3,%edx
        while(*s != 0){
