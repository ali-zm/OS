...
_test_gdb:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  25:	50                   	push   %eax
  26:	68 88 07 00 00       	push   $0x788
  2b:	6a 01                	push   $0x1
  2d:	e8 1e 04 00 00       	call   450 <printf>
    exit();
...
0000033b <get_most_syscalls>:
SYSCALL(get_most_syscalls)
 33b:	b8 19 00 00 00       	mov    $0x19,%eax
 340:	cd 40                	int    $0x40
 342:	c3                   	ret    

00000343 <list_active_processes>:
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 98 07 00 00 	jmp    *0x798(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba 8f 07 00 00       	mov    $0x78f,%edx
        while(*s != 0){
