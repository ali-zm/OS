...
00000663 <sort_syscalls>:
SYSCALL(sort_syscalls)
 663:	b8 18 00 00 00       	mov    $0x18,%eax
 668:	cd 40                	int    $0x40
 66a:	c3                   	ret    

0000066b <get_most_syscalls>:
