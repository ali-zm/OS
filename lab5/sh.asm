...
00000ecb <get_most_syscalls>:
SYSCALL(get_most_syscalls)
     ecb:	b8 19 00 00 00       	mov    $0x19,%eax
     ed0:	cd 40                	int    $0x40
     ed2:	c3                   	ret    

00000ed3 <list_active_processes>:
