...
_get_count_syscalls_all_cpus:     file format elf32-i386
...
int main(void)
{
   ...
   f:	e8 7f 03 00 00       	call   393 <count_syscalls_all_cpus>
  14:	89 c3                	mov    %eax,%ebx
    int count2 = sum_all_cpus_syscalls();
  16:	e8 80 03 00 00       	call   39b <sum_all_cpus_syscalls>
  ...
  29:	58                   	pop    %eax
  2a:	5a                   	pop    %edx
  2b:	68 b4 07 00 00       	push   $0x7b4
  30:	6a 01                	push   $0x1
  32:	e8 39 04 00 00       	call   470 <printf>
    count_syscalls_all_cpus(); // Call the system call again
  37:	e8 57 03 00 00       	call   393 <count_syscalls_all_cpus>
    
    count = count_syscalls_all_cpus();
  3c:	e8 52 03 00 00       	call   393 <count_syscalls_all_cpus>
  41:	89 c3                	mov    %eax,%ebx
    count2 = sum_all_cpus_syscalls();
  43:	e8 53 03 00 00       	call   39b <sum_all_cpus_syscalls>
    printf(1, "Total system calls after test: %d, %d\n", count, count2);
  48:	50                   	push   %eax
  49:	53                   	push   %ebx
  4a:	68 c4 07 00 00       	push   $0x7c4
  4f:	6a 01                	push   $0x1
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 f4 07 00 00 	jmp    *0x7f4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba eb 07 00 00       	mov    $0x7eb,%edx
        while(*s != 0){
 ...
 611:	a1 f8 0a 00 00       	mov    0xaf8,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d f8 0a 00 00    	mov    0xaf8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d f8 0a 00 00    	mov    0xaf8,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 f8 0a 00 00    	mov    0xaf8,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 f8 0a 00 00    	mov    %edx,0xaf8
}
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf fc 0a 00 00       	mov    $0xafc,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 fc 0a 00 00 fc 	movl   $0xafc,0xafc
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 00 0b 00 00 00 	movl   $0x0,0xb00
 782:	00 00 00 
    if(p->s.size >= nunits){
