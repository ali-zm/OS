...
_test_palindrome:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  27:	e8 37 03 00 00       	call   363 <create_palindrome>
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba c8 07 00 00       	mov    $0x7c8,%edx
        while(*s != 0){
