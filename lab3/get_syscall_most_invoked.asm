 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba ce 07 00 00       	mov    $0x7ce,%edx
        while(*s != 0){
 ...
 5f1:	a1 dc 0a 00 00       	mov    0xadc,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 dc 0a 00 00    	mov    %edx,0xadc
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 669:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66c:	89 15 dc 0a 00 00    	mov    %edx,0xadc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 4f                	jae    720 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	8b 3d dc 0a 00 00    	mov    0xadc,%edi
 ...
 6fa:	e8 f1 fe ff ff       	call   5f0 <free>
  return freep;
 6ff:	8b 15 dc 0a 00 00    	mov    0xadc,%edx
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 dc 0a 00 00 e0 	movl   $0xae0,0xadc
 747:	0a 00 00 
    base.s.size = 0;
 74a:	bf e0 0a 00 00       	mov    $0xae0,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 e0 0a 00 00 e0 	movl   $0xae0,0xae0
 756:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 75b:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 762:	00 00 00 
    if(p->s.size >= nunits){
