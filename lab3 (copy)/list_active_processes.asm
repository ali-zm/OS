...
int main()
{
   ...
   9:	83 e4 f0             	and    $0xfffffff0,%esp
    ...
    {
        int pid = fork();
   c:	e8 ba 02 00 00       	call   2cb <fork>
        // if(pid==6)  //check SJF
  ...
  18:	75 f2                	jne    c <main+0xc>
    ...
    show_process_info();
  1a:	e8 84 03 00 00       	call   3a3 <show_process_info>
    for (int i = 0; i < PROCS_NUM; i++)
        wait();
  1f:	e8 b7 02 00 00       	call   2db <wait>
  24:	e8 b2 02 00 00       	call   2db <wait>
  29:	e8 ad 02 00 00       	call   2db <wait>
  2e:	e8 a8 02 00 00       	call   2db <wait>
  33:	e8 a3 02 00 00       	call   2db <wait>
    exit();
  38:	e8 96 02 00 00       	call   2d3 <exit>
            test();
  3d:	e8 0e 00 00 00       	call   50 <test>
            exit();
...
00000050 <test>:
{
  ...
  53:	53                   	push   %ebx
  54:	bb 00 e1 f5 05       	mov    $0x5f5e100,%ebx
 ...
 611:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 bc 0a 00 00    	mov    %edx,0xabc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 bc 0a 00 00 c0 	movl   $0xac0,0xabc
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf c0 0a 00 00       	mov    $0xac0,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 782:	00 00 00 
    if(p->s.size >= nunits){
