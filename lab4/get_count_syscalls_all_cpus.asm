...
int main(void)
{
  ...
  11:	e8 7d 03 00 00       	call   393 <count_syscalls_all_cpus>
  ...
  34:	e8 5a 03 00 00       	call   393 <count_syscalls_all_cpus>
    
    count = count_syscalls_all_cpus();
  39:	e8 55 03 00 00       	call   393 <count_syscalls_all_cpus>
    printf(1, "Total system calls after test: %d\n", count);
  3e:	83 c4 0c             	add    $0xc,%esp
  41:	50                   	push   %eax
  42:	68 a0 07 00 00       	push   $0x7a0
  47:	6a 01                	push   $0x1
 ...
 459:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4c9:	ff 24 85 cc 07 00 00 	jmp    *0x7cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5d7:	90                   	nop
          s = "(null)";
 5d8:	ba c3 07 00 00       	mov    $0x7c3,%edx
        while(*s != 0){
