...
_get_syscall_most_invoked:     file format elf32-i386
...
int main(void) {
  ...
  19:	e8 52 04 00 00       	call   470 <printf>
    ...
    int pid = getpid();
  1e:	e8 30 03 00 00       	call   353 <getpid>
  23:	89 c3                	mov    %eax,%ebx
    if (fork() == 0) 
  25:	e8 a1 02 00 00       	call   2cb <fork>
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	75 13                	jne    44 <main+0x44>
    {
        printf(1, "In child process\n");
  31:	52                   	push   %edx
  32:	52                   	push   %edx
  33:	68 b1 07 00 00       	push   $0x7b1
  38:	6a 01                	push   $0x1
  3a:	e8 31 04 00 00       	call   470 <printf>
        exit();
  3f:	e8 8f 02 00 00       	call   2d3 <exit>
    } 
    else 
        wait();
  44:	e8 92 02 00 00       	call   2db <wait>
    sleep(10);
  49:	83 ec 0c             	sub    $0xc,%esp
  4c:	6a 0a                	push   $0xa
  4e:	e8 10 03 00 00       	call   363 <sleep>

    if (get_most_syscalls(pid) < 0) {
  53:	89 1c 24             	mov    %ebx,(%esp)
  56:	e8 20 03 00 00       	call   37b <get_most_syscalls>
  5b:	83 c4 10             	add    $0x10,%esp
  5e:	85 c0                	test   %eax,%eax
  60:	78 05                	js     67 <main+0x67>
        printf(1, "Error: Failed to retrieve syscall counts\n");
        exit();
    }

    exit();
  62:	e8 6c 02 00 00       	call   2d3 <exit>
        printf(1, "Error: Failed to retrieve syscall counts\n");
  67:	50                   	push   %eax
  68:	50                   	push   %eax
  69:	68 c4 07 00 00       	push   $0x7c4
  6e:	6a 01                	push   $0x1
...
000003ab <set_burst_confidence>:
SYSCALL(set_burst_confidence)
 3ab:	b8 1d 00 00 00       	mov    $0x1d,%eax
 3b0:	cd 40                	int    $0x40
 3b2:	c3                   	ret    

000003b3 <count_syscalls_all_cpus>:
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 f8 07 00 00 	jmp    *0x7f8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba ee 07 00 00       	mov    $0x7ee,%edx
        while(*s != 0){
 ...
 611:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 fc 0a 00 00    	mov    %edx,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 fc 0a 00 00    	mov    %edx,0xafc
}
 ...
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 776:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
