...
0000040b <get_most_syscalls>:
SYSCALL(get_most_syscalls)
 40b:	b8 19 00 00 00       	mov    $0x19,%eax
 410:	cd 40                	int    $0x40
 412:	c3                   	ret    

00000413 <list_active_processes>:
